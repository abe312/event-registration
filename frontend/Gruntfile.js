// Generated on 2018-02-23 using generator-angular 0.16.0
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    //   dist: {
    //     files: {
    //       '<%= yeoman.dist %>/styles/main.css': ['index.html']
    //     }
    //   }
    // },
    // uncss and then cssmin (use after angular combine)
    ...
    //     files : [ {
    //       cwd : '<%= yeoman.dist %>',
    //       src : ['index.html', 'views/views.html'],
      ...
      dist: {
        files: [{
          ...
          src: [
            ...
            '*.html',
            'views/*.html',
            'images/{,*/}*.{webp, img, png, jpg, jpeg, ico}',
            'styles/fonts/{,*/}*.*'
          ]
        }, {
          expand: true,
